...
public class PatientMethodList extends Patient{
    ...
    @Override
    public  Patient BreakAttributes(String line){
    ...
    public void DisplaySortingOption(){
        ...
        System.out.println("4 Sort By Depart");
    ...
    @Override
    public PatientS DeletePatientData(int id){
        Patient p = null;
        ...
        while(true){
         ...
         if(p.getId()==id)
         {
            ...
            //ps = new PatientS(p.getName(),p.getGender(),p.getAge(),p.getPhoneNumber(),p.getDepart(),p.getId());
             continue;
         }
