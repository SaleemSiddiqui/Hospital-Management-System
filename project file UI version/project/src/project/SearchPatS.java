    ...
    public void start(){
        ...
        seabut.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Patient sd= new PatientMethodList();
                switch(op){
                    case "By Id":
                        int id=Integer.parseInt(tx.getText());
                        System.out.println(id);
                        sd=sd.SearchPatientById(id);
                        if(sd==null)
                        {
                            ...
                            naL.setText(sd.getName());
                            agL.setText(String.valueOf(sd.getAge()));
                            pL.setText(String.valueOf(sd.getPhoneNumber()));
                            deL.setText(sd.getDepart());
                            gendL.setText(sd.getGender());
                            idnL.setText(String.valueOf(sd.getId()));
                        }
                    ...
                    case "By Name":
                        ...
                        sd=sd.SearchPatientByName(name);
                        if(sd==null)
                        {
                            NotFound.setVisible(true);
                        }else{
                    ...
                    case "By Phone_Number":
                        ...
                        sd=sd.SearchPatientByPhoneNumber(ph);
                        if(sd==null)
                        {
                            NotFound.setVisible(true);
                        }else{
