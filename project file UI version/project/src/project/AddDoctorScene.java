       ...
       final  RadioButton button2 = new RadioButton("Female");
        ...
        addbut.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    fh.setid();
                    add= new AddDoctor(nameText.getText(),Long.parseLong(phText.getText()),opt.getValue().toString(),toogleGroupValue,Integer.parseInt(ageText.getText()));
                    add.AddDoctorTOFIle();
                } catch (IOException ex) {
                    Logger.getLogger(AddDoctorScene.class.getName()).log(Level.SEVERE, null, ex);
